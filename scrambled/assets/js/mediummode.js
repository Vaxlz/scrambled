var words = ['people','before','around','little','should','moment','almost','really','family','always','father','mother','friend','school','inside','number','office']
let answer = null;
let word = null;
var medCracks = 0;
var time = 60;
...
function submitWord() {
    if(document.getElementById("text").innerHTML == word) {
        medCracks = medCracks + +1;
        document.getElementById("crackstext").innerHTML = "Cracks: " + medCracks;
        playCrack();
